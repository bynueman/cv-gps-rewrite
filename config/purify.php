...
return [
    ...
    */
    ...
    'configs' => [
        ...
        // Admin article rich-text body — matches the original Next.js app's
        // sanitize-html allowlist exactly (see App\Support\ArticleHtmlSanitizer).
        'article' => [
            'Core.Encoding' => 'utf-8',
            'HTML.Doctype' => 'HTML 4.01 Transitional',
            'HTML.Allowed' => 'p,br,strong,em,s,h2,h3,ul,ol,li,blockquote,a[href],img[src|alt|width|height]',
